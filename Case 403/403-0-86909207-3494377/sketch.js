...
Officer: 3494377
CaseNum: 403-0-86909207-3494377

Case 403 - Surveillance - stage 1

We are on the lookout for the criminal mastermind known as Shiffman. 

- Our sources tell us that he is currently heading south on Gosling Road. 
- I need you to sound the alarm if he crosses Turing Place.
- Shiffman's position is signified by the mouse. 
- To sound the alarm, draw a OrangeRed rectangle covering the remainder of the map from Turing Place to the south.
...
function draw()
{
    ...
    if(mouseY>1155)
        {
            fill(255,69,0);
            rect(0, 1155, img.width, img.height-1155);
        }
