...
Officer: 3494377
CaseNum: 402-2-57792586-3494377
...
function draw()
{
    ...
    if (det.locationX <700 && det.locationY <450)
	{
		det.speedX = -1;
		det.speedY = 0;if (det.locationX <700 && det.locationY <450)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
	}
    if (det.locationX <460 && det.locationY <450)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
    if (det.locationX <460 && det.locationY <250)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
    if (det.locationX <200 && det.locationY <250)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
    if (det.locationX <200 && det.locationY <130)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
